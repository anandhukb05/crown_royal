...
urlpatterns = [
    ...
    path("invoice/detail/<int:pk>/", patient_invoice_detail, name="patient_invoice_detail"),
    path("invoice/edit/<int:pk>/", patient_invoice_edit, name="patient_invoice_edit"),
    path("invoice/delete/<int:pk>/", patient_invoice_delete, name="patient_invoice_delete"),
